...
//
// Fixed to Four menu bar
//

import Foundation
import UIKit

protocol Menu4SelectionDelegate {
    func menuItemSelected(menuIdx : Int)
}
class MenuBar4:UIView, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout{
    
    var delegate : Menu4SelectionDelegate?
    ...
    override init(frame: CGRect) {
        ...
        collectionView.register(MenuCell4.self, forCellWithReuseIdentifier: reuseIdentifier)
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: reuseIdentifier, for: indexPath) as! MenuCell4
